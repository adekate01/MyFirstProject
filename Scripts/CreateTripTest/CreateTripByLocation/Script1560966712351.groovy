...
not_run: WebUI.click(findTestObject('CreateTripPage/Location/ChooseCoverPhoto'))

not_run: WebUI.delay(4)

not_run: WebUI.clickImage(findTestObject('CreateTripPage/Location/ChooseCoverPhoto'), FailureHandling.STOP_ON_FAILURE)
